...
public interface IChangeStore
{
    ...
    IAsyncEnumerable<ChangeSet> GetChangeSetsAsync(DateTime fromUtc, DateTime toUtc, CancellationToken cancellationToken);
    IAsyncEnumerable<ChangeSet> GetChangeSetsAsync(long fromChangeSetId, CancellationToken cancellationToken);
    ValueTask DeleteChangeSetAsync(long changeSetId, CancellationToken cancellationToken);
